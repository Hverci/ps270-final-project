...
### Research Design
My research design is cross-sectional.  

### Dependent and Independent Variables 
My independent variable is the democracy level of a country. In this project I used the total aggregate democratic score level from the “Freedom House” data set and the electoral democracy classification variable from the "Electoral Democracy" data. The total score variable is on a scale from 0 to 100, where 100 represents the highest level of freedom and 0 the lowest. The electoral democracy classification variable is either Yes(for an electoral democracy) or No(for a non-electoral democracy).
...
### Visualization of the Outcome Variable - Voter Turnout 
```{r, echo = FALSE}

ggplot(data = Joined_data_extra_clean, aes(x = `Voter Turnout`)) +
  geom_histogram(binwidth = 5, fill = "indianred") +
